      ...
      mySystem = {
        usbguard = {
          ...
          rules = ''
            ...
            allow id 058f:9540 serial "" name "EMV Smartcard Reader" hash "j6z/wqFtA1bZWwBIPmIr/g8KfsEQJ63vpgf4cBcNLbU=" parent-hash "pz29Oo0RhQ+5+7LgOZR4v3OlcsVv3m9kCgGsGUnoUjI=" via-port "3-3" with-interface 0b:00:00 with-connect-type "unknown"
            allow id 06cb:00bd serial "63fca17d8711" name "" hash "hzchVuNcbEL4hPcdm2HeT//pL5wUZasLbB2hSl31Cas=" parent-hash "Hp8B0Enf+ACRT2tyy0EqXj7eNsFDAnTRZadzuh/Iqd4=" with-interface ff:00:00 with-connect-type "unknown"
            allow id 0489:e0cd serial "000000000" name "Wireless_Device" hash "3JopVFWGRS5OUECbrpyI91sYwRcWP7uB1x2MwHhAtnM=" parent-hash "Hp8B0Enf+ACRT2tyy0EqXj7eNsFDAnTRZadzuh/Iqd4=" with-interface { e0:01:01 e0:01:01 e0:01:01 e0:01:01 e0:01:01 e0:01:01 e0:01:01 e0:01:01 e0:01:01 e0:01:01 } with-connect-type "unknown"
          '';
        };
        vpn = {
          enable = true;
