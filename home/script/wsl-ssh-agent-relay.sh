...
# source : https://github.com/rupor-github/wsl-ssh-agent/blob/66444a1e35b416832ede837090b2b7509ab1615c/docs/wsl-ssh-agent-relay
...
#### Assuming ~/ links to %USERPROFILE on Windows side
RELAY_BIN="${HOME}/.wsl/npiperelay.exe"
