...
}:
{
  programs.noctalia-shell = {
    ...
    settings = {
      ...
      general = {
        avatarImage = "/home/lortega/.config/wallpapers/avatar.png";
        dimmerOpacity = 0.2;
      ...
      wallpaper = {
        ...
        directory = "/home/lortega/.config/wallpapers";
        monitorDirectories = [ ];
      ...
      controlCenter = {
        ...
        shortcuts = {
          left = [
            ...
            {
              enableOnStateLogic = false;
              generalTooltipText = "Color picker";
              icon = "color-picker";
              id = "CustomButton";
              onClicked = "hyprpicker -a";
              onMiddleClicked = "";
              onRightClicked = "";
              stateChecksJson = [ ];
            }
